...
const sourceFiles = ["apps/site/src/env.d.ts", "apps/cms/src/payload.config.ts", "packages/shared/src/index.ts", "packages/shared/src/config.ts", "packages/shared/src/config.mjs"];
